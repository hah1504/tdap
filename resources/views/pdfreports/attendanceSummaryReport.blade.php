    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <h2 align="center">Attendance Summary Report</h2>
                                ...
                                @php
                                    foreach($ataData as $key =>$value){
                                        echo "<tr>";
                                            ...
                                            echo "<td>".(isset($value['presentDays']) ? $value['presentDays'] : 0)."</td>";
                                            echo "<td>".$weedendDays."</td>";
                                            echo "<td>".$holidayDays."</td>";
                                            echo "<td>".(isset($value['absentDays']) ? $value['absentDays'] : 0)."</td>";
                                            echo "<td>".(isset($value['leaveDays']) ? $value['leaveDays'] : 0)."</td>";
                                        echo "</tr>";
                                        }
                                    @endphp
